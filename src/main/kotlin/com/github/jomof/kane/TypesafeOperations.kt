...
fun count(scalar: ScalarExpr): ScalarExpr = countFunc.invoke(scalar)
...
fun nans(scalar: ScalarExpr): ScalarExpr = nansFunc.invoke(scalar)
...
fun mean(scalar: ScalarExpr): ScalarExpr = meanFunc.invoke(scalar)
...
fun min(scalar: ScalarExpr): ScalarExpr = minFunc.invoke(scalar)
...
fun percentile25(scalar: ScalarExpr): ScalarExpr = percentile25Func.invoke(scalar)
...
fun median(scalar: ScalarExpr): ScalarExpr = medianFunc.invoke(scalar)
...
fun percentile75(scalar: ScalarExpr): ScalarExpr = percentile75Func.invoke(scalar)
...
fun max(scalar: ScalarExpr): ScalarExpr = maxFunc.invoke(scalar)
...
fun variance(scalar: ScalarExpr): ScalarExpr = varianceFunc.invoke(scalar)
...
fun stdev(scalar: ScalarExpr): ScalarExpr = stdevFunc.invoke(scalar)
...
fun skewness(scalar: ScalarExpr): ScalarExpr = skewnessFunc.invoke(scalar)
...
fun kurtosis(scalar: ScalarExpr): ScalarExpr = kurtosisFunc.invoke(scalar)
...
fun cv(scalar: ScalarExpr): ScalarExpr = cvFunc.invoke(scalar)
...
fun sum(scalar: ScalarExpr): ScalarExpr = sumFunc.invoke(scalar)
