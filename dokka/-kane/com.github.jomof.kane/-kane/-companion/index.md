...
| <a name="com.github.jomof.kane/Kane.Companion/userCacheFolder/#/PointingToDeclaration/"></a>[userCacheFolder](user-cache-folder.md)| <a name="com.github.jomof.kane/Kane.Companion/userCacheFolder/#/PointingToDeclaration/"></a> [jvm] val [userCacheFolder](user-cache-folder.md): [File](https://docs.oracle.com/javase/8/docs/api/java/io/File.html)Folder used for caching intermediates.   <br>
