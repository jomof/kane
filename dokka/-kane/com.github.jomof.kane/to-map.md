//[Kane](../index.md)/[com.github.jomof.kane](index.md)/[toMap](to-map.md)
...
[jvm]  
Content  
fun [NamedExpr](../com.github.jomof.kane.impl/-named-expr/index.md).[toMap](to-map.md)(): [Map](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-map/index.html)<[String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), [List](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-list/index.html)<[Any](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-any/index.html)?>>  
More info  


Convert this [NamedExpr](../com.github.jomof.kane.impl/-named-expr/index.md) to a map where the key is column name and the value is a list of cell values for that column. Nested column vectors will be expanded.
