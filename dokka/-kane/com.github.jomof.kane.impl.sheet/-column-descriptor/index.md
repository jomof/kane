...
# ColumnDescriptor  
 [jvm] data class [ColumnDescriptor](index.md)(**name**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), **type**: [AdmissibleDataType](../-admissible-data-type/index.md)<*>?)   
...
| <a name="com.github.jomof.kane.impl.sheet/ColumnDescriptor/copy/#kotlin.String#com.github.jomof.kane.impl.sheet.AdmissibleDataType[*]?/PointingToDeclaration/"></a>[copy](copy.md)| <a name="com.github.jomof.kane.impl.sheet/ColumnDescriptor/copy/#kotlin.String#com.github.jomof.kane.impl.sheet.AdmissibleDataType[*]?/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>fun [copy](copy.md)(name: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), type: [AdmissibleDataType](../-admissible-data-type/index.md)<*>?): [ColumnDescriptor](index.md)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.github.jomof.kane.impl.sheet/ColumnDescriptor/name/#/PointingToDeclaration/"></a>[name](name.md)| <a name="com.github.jomof.kane.impl.sheet/ColumnDescriptor/name/#/PointingToDeclaration/"></a> [jvm] val [name](name.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
